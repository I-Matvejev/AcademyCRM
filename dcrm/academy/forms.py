...
class CourseAttendeesForm(forms.ModelForm):
    ...
    attendee_last_name_rus = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder": "Фамилия", "class": "form-control"}), label="")
    attendee_first_name_rus = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder": "Имя", "class": "form-control"}), label="")
    attendee_fathers_name_rus = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder": "Отчество", "class": "form-control"}), label="")
    attendee_last_name_eng = forms.CharField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder": "Surname", "class": "form-control"}), label="")
