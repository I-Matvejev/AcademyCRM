...
class Attendee(models.Model):
    ...
    attendee_last_name_rus = models.CharField(blank=True, max_length=50, validators=[name_validator_rus])
    attendee_first_name_rus = models.CharField(blank=True, max_length=20, validators=[name_validator_rus])
    attendee_fathers_name_rus = models.CharField(blank=True, max_length=50, validators=[name_validator_rus])
    attendee_last_name_eng = models.CharField(blank=True, max_length=50, validators=[name_validator_eng])
    attendee_first_name_eng = models.CharField(blank=True, max_length=20, validators=[name_validator_eng])
    attendee_email = models.EmailField(blank=True, max_length=100)
    attendee_phone = models.CharField(blank=True, max_length=20)
    attendee_company = models.CharField(max_length=100)
    attendee_position = models.CharField(blank=True, max_length=100)
    attendee_contract_number = models.CharField(blank=True, max_length=100)
